          ...
          {users?.length === 0 ? (
            ...
            users.map((user) => (
              <Link
                ...
                className="flex items-center relative space-y-2 p-2 rounded-lg focus:bg-green-100 transition-colors ease-in-out duration-300 cursor-pointer"
              >
                {(user.picturePath && (
                  <img
                ...
                {onlineUsers.includes(user._id) && (
                    <span className="absolute z-30 left-8 bottom-1">
